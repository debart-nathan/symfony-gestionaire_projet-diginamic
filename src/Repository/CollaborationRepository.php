...
class CollaborationRepository extends ServiceEntityRepository
{
    ...
    // In your CollaborationRepository

public function findAdminUserByProject(Project $project)
{
    $collaboration = $this->findOneBy(['project' => $project, 'isAdmin' => true]);

    if ($collaboration) {
        return $collaboration->getUser();
    }
